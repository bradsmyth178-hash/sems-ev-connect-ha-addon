...
- The **pairing code** you were given — eight characters, like `K7P2-9QMX`. It is
  single-use and expires after seven days, so ask for a fresh one if it has been used.
- A **control PIN** — but only if you want to choose your own. Leave it blank and
  one is generated and shown once on the setup page. It protects the charging
  controls on your home network.
